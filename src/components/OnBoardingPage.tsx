...
const [isVisible, setIsVisible] = useState(false);
  ...
  return (
    ...
    <div className="h-screen py-16 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row">
        {/* Left Side - Video */}
        <div className="w-full md:w-1/2 relative mb-8 md:mb-0 md:mr-8">
          <div className="rounded-lg h-64 md:h-auto flex items-center justify-center">
            <video
              ref={videoRef}
        ...
        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
          <h2 className="text-red-600 text-lg font-bold mb-2">WELCOME TO A SMOOTH START</h2>
          <h1 className="text-4xl font-bold mb-4">Effortless Onboarding and Seamless Transition</h1>
