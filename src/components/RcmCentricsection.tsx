...
export default function RCMCentricSection() {
  const [rightColumnRef, isRightColumnVisible] = useIntersectionObserver({
    threshold: 0,
    ...
    <section className="bg-blue-100 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          {/* Right Column - Scrolling Content with CSS Animation */}
          <div
            ref={rightColumnRef}
            className={`space-y-8 ${isRightColumnVisible ? "animate-slide-up" : "slide-up-hidden"}`}
          >
            {features.map((feature) => (
              <div
                key={feature.title}
                className="flex items-start gap-4 p-6 rounded-lg hover:bg-white/50 transition-colors duration-300"
              >
            ...
            <div className="bg-blue-600 rounded-lg p-8 text-center text-white shadow-lg">
